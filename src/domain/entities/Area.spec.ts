...
describe('Area.reconstitute', () => {
  it('hydrates an Area from a D1 row', () => {
    const row = {
      id: 'area-1',
      workspace_id: 'ws-1',
      name: 'Work',
    ...
    const area = Area.reconstitute(row);
  ...
  it('reconstitutes an archived area without validation', () => {
    const row = {
      id: 'area-2',
      workspace_id: 'ws-2',
      name: 'Personal',
