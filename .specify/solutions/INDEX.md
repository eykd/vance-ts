...
- [Port Interfaces Consistently Defined in Application Layer](clean-architecture/port-interfaces-in-wrong-layer.md) — port/repository interfaces keep being created in application instead of domain; plans must explicitly place them in `src/domain/` (2026-03-30)
